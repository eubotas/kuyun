...
INSERT INTO eam_code_value (category,code_value,code_name,description,create_user_id,create_time,update_user_id,update_time,delete_flag) VALUES ('FILE_TEMPLATE','4','数据点表模板','',1,now(),1,now(),0);
