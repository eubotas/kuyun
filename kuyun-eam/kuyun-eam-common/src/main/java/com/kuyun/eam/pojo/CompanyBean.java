...
public class CompanyBean extends BaseImportBean{
    ...
    public String[] getSortedProperty() {
        return new String[]{"id", "name", "year", "taskNumber", "state", "country", "province", "city", "industry", "productLineType", "hasCxg", "hasZnlk", "productLineCapacity", "packagingMaterial", "productSpec", "majorEquipment", "comment"};
    }
