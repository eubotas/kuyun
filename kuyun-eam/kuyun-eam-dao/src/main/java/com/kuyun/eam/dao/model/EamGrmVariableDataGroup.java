...
public class EamGrmVariableDataGroup extends BaseEntity implements Serializable {
    private Integer id;

    private Integer eamGrmVariableDataId;
    ...
    public Integer getEamGrmVariableDataId() {
        return eamGrmVariableDataId;
    }

    public void setEamGrmVariableDataId(Integer eamGrmVariableDataId) {
        this.eamGrmVariableDataId = eamGrmVariableDataId;
    }
    ...
    public String toString() {
        ...
        sb.append(", eamGrmVariableDataId=").append(eamGrmVariableDataId);
    ...
    public boolean equals(Object that) {
        ...
        EamGrmVariableDataGroup other = (EamGrmVariableDataGroup) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            && (this.getEamGrmVariableDataId() == null ? other.getEamGrmVariableDataId() == null : this.getEamGrmVariableDataId().equals(other.getEamGrmVariableDataId()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getEamGrmVariableDataId() == null) ? 0 : getEamGrmVariableDataId().hashCode());
