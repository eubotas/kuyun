...
public class EamSensorWriteDataHistory extends BaseEntity implements Serializable {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        EamSensorWriteDataHistory other = (EamSensorWriteDataHistory) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getWriteValue() == null ? other.getWriteValue() == null : this.getWriteValue().equals(other.getWriteValue()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getWriteValue() == null) ? 0 : getWriteValue().hashCode());
