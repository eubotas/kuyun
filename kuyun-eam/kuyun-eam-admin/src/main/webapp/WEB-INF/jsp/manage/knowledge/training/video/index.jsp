...
function createAction() {
	createDialog = $.dialog({
		...
		title: '新增培训视频',
		columnClass: 'xlarge',
		content: 'url:${basePath}/manage/knowledge/training/video/create',
...
function updateAction() {
	...
	if (rows.length != 1) {
		...
		updateDialog = $.dialog({
			...
			title: '编辑培训视频',
			columnClass: 'xlarge',
			content: 'url:${basePath}/manage/knowledge/training/video/update/' + rows[0].id,
			onContentReady: function () {
				initMaterialInput();
				$('select').select2();
			}
            ...
            buttons: {
                confirm: {
                    ...
                    action: function () {
                        ...
                        $.ajax({
                            type: 'get',
                            url: '${basePath}/manage/knowledge/training/video/delete/' + ids.join("::"),
