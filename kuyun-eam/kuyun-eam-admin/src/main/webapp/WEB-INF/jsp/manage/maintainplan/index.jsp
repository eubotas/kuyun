...
<script>
    ...
    function actionFormatter(value, row, index) {
        return [
            '<a class="update" href="javascript:;" onclick="detailAction(\'维修计划详细\',\'${basePath}/manage/maintainPlan/detail\',\'planId\')" data-toggle="tooltip" title="Detail"><i class="glyphicon glyphicon-edit"></i></a>　',
