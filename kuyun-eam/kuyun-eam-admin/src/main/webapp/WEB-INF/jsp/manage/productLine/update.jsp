			...
			<div class="col-sm-6">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="longitude" type="text" class="form-control" name="longitude" maxlength="100" value="${eamProductLine.longitude}">
					</div>
				</div>
			</div>
			<div class="col-sm-6">
				<div class="form-group">
					<div class="fg-line">
						...
						<input id="latitude" type="text" class="form-control" name="latitude" maxlength="100" value="${eamProductLine.latitude}">
					</div>
				</div>
			</div>
