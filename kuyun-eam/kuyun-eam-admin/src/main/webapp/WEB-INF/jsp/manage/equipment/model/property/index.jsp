...
<pageResources>
    ...
    <script>
        $(document).ready(function()
        {
            ...
            generateAddEditForm('template-equipmentCategory-addEditForm', 'add_,edit_', null, null, 'addEquipmentModelPropertyFormContainer,editEquipmentModelPropertyFormContainer');
        ...
        function updateAction(row) {
            ...
            ajaxGet('${basePath}/manage/equipment/model/property/update/' + row["equipmentModelPropertyId"], function (responseData) {
                if (responseData) {
                    ...
                    // 赋值
                    $("#edit_id").val(data.equipmentCategory.equipmentModelPropertyId);
