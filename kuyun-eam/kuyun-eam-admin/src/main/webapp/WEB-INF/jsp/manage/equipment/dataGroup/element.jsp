...
<script>
    ...
    $(function() {
        ...
        $tableEquipment.bootstrapTable({
            url: '${basePath}/manage/${equipmentId}/dataGroup/${dataGroupId}/${equipmentDataGroupId}/list',
            height: getHeight(),
...
function createSubmit() {
    ...
    if (rows.length == 0) {
        ...
        $.ajax({
            type: 'get',
            url: '${basePath}/manage/${equipmentId}/dataGroup/${dataGroupId}/${equipmentDataGroupId}/confirm',
            data: {ids: ids.join("::")},
