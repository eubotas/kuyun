...
<content>
    ...
    <div class="m-portlet m-portlet--mobile">
        <div class="m-portlet__body">
            <div id="toolbar">
                <div>
                    <shiro:hasPermission name="eam:maintainKnowledge:create"><a href="#" id="createButton" class="btn btn-outline-primary m-btn m-btn--icon m-btn--icon-only" title="新建">
                        <i class="la la-plus"></i>
                    </a></shiro:hasPermission>

                    <shiro:hasPermission name="eam:maintainKnowledge:delete"><a href="#" id="deleteButton" class="btn btn-outline-danger m-btn m-btn--icon m-btn--icon-only" title="删除">
    ...
    <div class="modal fade" id="template-maintainKnowledge-addEditForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        ...
        function updateAction(row) {
            ...
            ajaxGet('${basePath}/manage/knowledge/maintain/update/' + row["id"], function (responseData) {
                if (responseData) {
                    ...
                    $("#edit_companyId").val(data.maintain.companyId);
