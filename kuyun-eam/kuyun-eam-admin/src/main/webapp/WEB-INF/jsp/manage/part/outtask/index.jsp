...
<div id="outTaksDialog" class="crudDialog">
	<form id="createForm" method="post">
		...
		<div class="form-group text-right dialog-buttons">
			...
			<a class="waves-effect waves-button" href="javascript:;" onclick="outTaksDialog.close();">取消</a>
		</div>
	</form>
</div>
<script>
function createSubmit() {
    $.ajax({
        type: 'post',
        url: '${basePath}/manage/part/outtask',
