 ...
 */
@Controller
@Api(value = "产线数据采集", description = "产线数据采集")
@RequestMapping("/manage/productLine/collect")
public class EamProductLineCollectController extends BaseController {

	private static Logger _log = LoggerFactory.getLogger(EamProductLineCollectController.class);
	...
	public String index() {
		return "/manage/productLine/collect/index.jsp";
	}
	...
	public Object start(@RequestBody String jsonString) {
		int count = eamApiService.handleProductLineCollect(jsonString, WORKING);
	...
	public Object stop(@RequestBody String jsonString) {
		int count = eamApiService.handleProductLineCollect(jsonString, NO_START);
		return new EamResult(SUCCESS, count);
	}
