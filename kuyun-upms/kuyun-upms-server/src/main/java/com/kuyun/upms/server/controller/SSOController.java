...
import com.kuyun.common.util.HuaWeiSaasUtil;
...
public class SSOController extends BaseController {
  ...
  // 全局会话key
  private static final String kuyun_UPMS_SERVER_SESSION_ID = "kuyun-upms-server-session-id";
  // 全局会话key列表
  private static final String kuyun_UPMS_SERVER_SESSION_IDS = "kuyun-upms-server-session-ids";
  // code key
  private static final String kuyun_UPMS_SERVER_CODE = "kuyun-upms-server-code";

  @Autowired UpmsSystemService upmsSystemService;

  @Autowired UpmsUserService upmsUserService;

  @Autowired UpmsSessionDao upmsSessionDao;
  ...
  public Object login(HttpServletRequest request, HttpServletResponse response, ModelMap modelMap) {
    ...
    if (StringUtils.isBlank(hasCode)) {
      ...
      // 全局会话的code
      RedisUtil.set(
          kuyun_UPMS_SERVER_SESSION_ID + "_" + sessionId,
          code,
          (int) subject.getSession().getTimeout() / 1000);
      // code校验值
      RedisUtil.set(
          kuyun_UPMS_SERVER_CODE + "_" + code,
          code,
          (int) subject.getSession().getTimeout() / 1000);
  ...
  public Object manage1(HttpServletRequest request, ModelMap modelMap) {
    ...
    upmsApiService.updateUser(user);
