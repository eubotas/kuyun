...
<head>
	...
	<link href="${basePath}/resources/kuyun-admin/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/kuyun-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/kuyun-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/kuyun-admin/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/kuyun-admin/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; kuyun-UPMS V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><b>演示地址</b>：<a href="http://www.kuyun.cn/kuyunAdmin" target="_blank">http://www.kuyun.cn/kuyunAdmin</a></p>
...
<script src="${basePath}/resources/kuyun-admin/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/kuyun-admin/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/kuyun-admin/plugins/device.min.js"></script>
<script src="${basePath}/resources/kuyun-admin/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/kuyun-admin/js/admin.js"></script>
<script src="${basePath}/resources/kuyun-admin/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/kuyun-admin/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>