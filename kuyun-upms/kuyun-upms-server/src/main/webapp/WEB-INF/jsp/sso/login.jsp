...
<head>
    ...
    <link href="${basePath}/resources/kuyun-admin/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
    <link href="${basePath}/resources/kuyun-admin/plugins/checkbix/css/checkbix.min.css" rel="stylesheet"/>
...
<div id="login-window">
    <div class="input-group m-b-20">
        ...
        <div class="fg-line">
            <input id="username" type="text" class="form-control" name="username" placeholder="帐号" required autofocus value="18652424835">
        </div>
    </div>
    <div class="input-group m-b-20">
...
<script src="${basePath}/resources/kuyun-admin/plugins/checkbix/js/checkbix.min.js"></script>
